...
import eu.getsoftware.cleanarchitecture.users.domain.model.tempDomainObjects.TempUserFactory;
 ...
 */
//@Service
public abstract class UserInputPortUseCaseAbstr<T extends IUserDomain, Z extends IUserDTO> implements IUserInputPortUseCase
{
    ...
    private final RegisterServiceAbstr<T, Z> userRegisterService;
     ...
     */
    public UserInputPortUseCaseAbstr(
//            IUserRegisterApplicationDsGatewayService userRegisterDfGateway, 
            ...
            RegisterServiceAbstr<T, Z> userRegisterService,
